...
{
	import com.vidiun.vo.VidiunContextDataResult;

	[Bindable]
	public dynamic class VidiunEntryContextDataResult extends VidiunContextDataResult
	{
		/**
		...
		override public function getElementType(arrayName:String):String
		{
			...
			switch (arrayName) {
				...
				case 'accessControlActions':
					result = 'VidiunAccessControlAction';
					break;
				case 'flavorAssets':
					result = 'VidiunFlavorAsset';
					break;
				default:
